    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="space-y-10 px-0 md:px-10 max-w-6xl">
            <a className="text-4-xl font-semibold text-center" href="https://autonomous-car.vercel.app/">
              <span className="underline decoration-[#708B75]/50 "></span>{" "}
        ...
        >
          ...
          <div className="space-y-10 px-0 md:px-10 max-w-6xl ">
            <a className="text-4-xl font-semibold text-center" href="https://distracker-2223.web.app/">
              <span className="underline decoration-[#708B75]/50 "></span>{" "}
